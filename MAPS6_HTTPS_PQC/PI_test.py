...
p = subprocess.Popen(os.environ.get('OPENSSL') + " req -new -newkey " + os.environ.get('SIG_ALG') + " -keyout /home/MAPS6_MVP/certs/client.key -out /home/MAPS6_MVP/certs/client.csr -nodes -subj \"/O=test-client/CN=" + os.environ.get('CIP') + "\"", shell=True)
p.wait()

# generate the publisher cert
p = subprocess.Popen(os.environ.get('OPENSSL') + " x509 -req -in /home/MAPS6_MVP/certs/client.csr -out /home/MAPS6_MVP/certs/client.crt -CA /home/MAPS6_MVP/certs/CA.crt -CAkey /home/MAPS6_MVP/certs/CA.key -CAcreateserial -days 365", shell=True)
p.wait()

# modify file permissions
p = subprocess.Popen("chmod 777 /home/MAPS6_MVP/certs/*", shell=True)
p.wait()
